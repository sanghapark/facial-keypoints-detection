...
for batch_index in range(1, int(np.ceil(X_test.shape[0]/batch_size)+1)):
    ...
    print("Predicting {} ~ {} test images ({}, {})".format(start, end, len(X_test[start:end,]), len(Y_predicted)))
    partial_output = ud.batch_output_for_kaggle_submission(Y_predicted, start, end)
